...
import pied1 from '../public/assets/img/configurateur/pied1.png';
import Image from "next/image";
import pied2 from '../public/assets/img/configurateur/pied2.png';
import pied3 from '../public/assets/img/configurateur/pied3.png';
import chaise_ref from '../public/assets/img/configurateur/chaise-ref.png';
...
export default function Configurateur() {
    ...
    const configurateur = () => {
        function _getClosest(item, array, getDiff) {
            ...
            array.forEach(function (comparedItem, comparedItemIndex) {
              let thisDiff = getDiff(comparedItem, item);
    ...
    return (
        ...
        <Image id="ref" src={chaise_ref} alt='Pied de référence'/>
            <div className="slider js-slider">
                <div className="slider__inner js-slider__inner">
                    <div className="slide js-slide">
                        ...
                        <Image src={pied1} alt='Pied1'/>
                        </div>
                    </div>
                    <div className="slide js-slide">
                        <div className="slide__bg">
                        <Image src={pied2} alt='Pied2'/>
                        </div>
                    </div>
                    <div className="slide js-slide">
                        <div className="slide__bg">
                        <Image src={pied3} alt='Pied3'/>
                        </div>
                    </div>
            ...
            {/* <div className="text text--bottom-left">Dragger pour selectionner un pied</div> */}
        </section>
        </>
    )
};